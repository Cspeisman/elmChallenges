this has been forked from [https://github.com/pdamoc/elmChallenges](https://github.com/pdamoc/elmChallenges). All files prefixed with `my-` are my solutions. All other files are the original author's solutions.
