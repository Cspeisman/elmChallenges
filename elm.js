...
Elm.Main.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      var _p5 = action;
      switch (_p5.ctor)
      {case "Draw": var _p6 = randomPair(model);
           var newCoords = _p6._0;
           var newSeed = _p6._1;
           return model.isRunning ? {ctor: "_Tuple2"
                                    ,_0: _U.update(model,
                                    {circles: A2($Basics._op["++"],model.circles,_U.list([circle(newCoords)])),seed: newSeed,windowDim: _p5._0})
                                    ,_1: $Effects.none} : {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "Reset": var _p7 = _p5._0;
           return _U.eq(_p7,112) && model.isRunning ? {ctor: "_Tuple2",_0: _U.update(model,{isRunning: false}),_1: $Effects.none} : _U.eq(_p7,
           112) && $Basics.not(model.isRunning) ? {ctor: "_Tuple2",_0: _U.update(model,{isRunning: true}),_1: $Effects.none} : _U.eq(_p7,114) ? {ctor: "_Tuple2"
                                                                                                                                                ,_0: _U.update(model,
                                                                                                                                                {circles: _U.list([])})
   ...
   var init = {circles: _U.list([]),seed: initalSeed,coordinates: {ctor: "_Tuple2",_0: 0,_1: 0},windowDim: {ctor: "_Tuple2",_0: 0,_1: 0},isRunning: true};
   var app = $StartApp.start({init: {ctor: "_Tuple2",_0: init,_1: $Effects.none}
                             ,view: view
                             ,update: update
                             ,inputs: _U.list([A3($Signal.map2,F2(function (_p8,d) {    return Draw(d);}),timer,$Window.dimensions)
                                              ,A2($Signal.map,function (key) {    return Reset(key);},$Keyboard.presses)])});
   var main = app.html;
   var Model = F5(function (a,b,c,d,e) {    return {circles: a,seed: b,coordinates: c,windowDim: d,isRunning: e};});
